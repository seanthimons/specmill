...
-   expose editable configuration and reconcile excluded grouped
    endpoints
    ([4203a01](https://github.com/seanthimons/specmill/tree/4203a01dfa12b1688b0f97c293749b6e4323d576))
-   generate configured clients with transport and authentication
    support (#5)
...
Full set of changes:
[`v0.1.4...2469955`](https://github.com/seanthimons/specmill/compare/v0.1.4...2469955)
