...
| `readOnly`/`writeOnly` request semantics | **Unsupported (silent)** | These keywords are accepted as known annotations ([`body_shapes.R`](../../../R/body_shapes.R#L31)) but request validation treats every `required` property alike ([`body_shapes.R`](../../../R/body_shapes.R#L423)). Under OAS 3.0/3.1, a required `readOnly` property applies only to responses; the generated request incorrectly requires it. Reproduced by [`read-only-request.json`](../../../tests/fixtures/capability-audit/read-only-request.json) and tracked in [GH #22](https://github.com/seanthimons/specmill/issues/22). |
